...
def get_all_plaza_ids():
    ...
    headers = {
        ...
        'Origin': 'https://www.kaggle.com/datasets/krantiswalke/bankfullcsv',
        'DNT': '1',
        'Connection': 'keep-alive',
        'Referer': 'https://www.kaggle.com/datasets/krantiswalke/bankfullcsv',
    ...
    response = requests.post('https://www.kaggle.com/datasets/krantiswalke/bankfullcsv', cookies=cookies,
